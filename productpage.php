...
<body>
  ...
  <section class="arrival-section">
    ...
    <div class="row">
      <div class="col">
        <span class="arrival-heading">Products</span>
      </div>
        ...
        <div class="col-lg-3">
          <div class="card product-card h-100 shadow">
            ...
            <div class="card-body text-center">
              ...
              <p class="card-text">Metallic finish ball point pens available in a wide range of colours and ink depths available for purchase</p>
        ...
        <div class="col-lg-3">
          <div class="card product-card h-100 shadow">
            ...
            <div class="card-body text-center">
              ...
              <p class="card-text">HB quality affordable pencils available for immediate purchase</p>
        ...
        <div class="col-lg-3">
          <div class="card product-card h-100 shadow">
            ...
            <div class="card-body text-center">
              ...
              <p class="card-text">Sharp and Casio calculators available for your day to day calculating needs at affordable prices.</p>
        ...
        <div class="col-lg-3">
          <div class="card product-card h-100 shadow">
            ...
            <div class="card-body text-center">
              ...
              <p class="card-text">High end kicks available in a wide variety of colours at student friendly prices .</p>
        ...
        <div class="col-lg-3">
          <div class="card product-card h-100 shadow">
            ...
            <div class="card-body text-center">
              ...
              <p class="card-text">Beautiful high quality tops available for immediate purchase at affordable prices</p>
        ...
        <div class="col-lg-3">
          <div class="card product-card h-100 shadow">
            ...
            <div class="card-body text-center">
              ...
              <p class="card-text">Affordable leather and pleather bags available for purchase</p>
        ...
        <div class="col-lg-3">
          <div class="card product-card h-100 shadow">
            ...
            <div class="card-body text-center">
              ...
              <p class="card-text">notebooks, planners and other stationary supplies available for immediate purchase</p>
        ...
        <div class="col-lg-3">
          <div class="card product-card h-100 shadow">
            ...
            <div class="card-body text-center">
              ...
              <p class="card-text">reasonably sized pencil cases available for your stationary storage requirements</p>
        ...
        <div class="col-lg-3">
          <div class="card product-card h-100 shadow">
            ...
            <div class="card-body text-center">
              ...
              <p class="card-text">Mouth watering fluffy muffins readily available for purchase</p>
        ...
        <div class="col-lg-3">
          <div class="card product-card h-100 shadow">
            ...
            <div class="card-body text-center">
              ...
              <p class="card-text">High quality stretch material jeans available for purchase</p>
        ...
        <div class="col-lg-3">
          <div class="card product-card h-100 shadow">
            ...
            <div class="card-body text-center">
              ...
              <p class="card-text">reasonably priced rings of heaven available for immediate purchase</p>
        ...
        <div class="col-lg-3">
          <div class="card product-card h-100 shadow">
            ...
            <div class="card-body text-center">
              ...
              <p class="card-text"> good quality fresh fruits readily available</p>
        ...
        <div class="col-lg-3">
          <div class="card product-card h-100 shadow">
            ...
            <div class="card-body text-center">
              ...
              <p class="card-text">Stylish head turning heels available for immediate purchase at budget friendly prices</p>
