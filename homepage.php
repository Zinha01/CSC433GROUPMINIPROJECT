        ...
        <div class="card-group gap-2 mx-3 mb-3">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">we offer a wide variety of quality services at budget friendly prices</p>
                    <a href="services.php" style="text-align:center">visit page</a>
                </div>
            </div>
            <div class="card">
                <img src="./images/pencil-case.jpg" class="card-img-top img-fluid" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Products</h5>
                    <p class="card-text">we offer a wide range of quality products at affordable prices
                    </p>
                    <a href="productpage.php" style="text-align:center">visit page</a>
                </div>
            </div>
            <div class="card">
                <img src="./images/student.jpg" class="card-img-top img-fluid" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Trader Profile</h5>
                    <p class="card-text">View your profile and upload items you would like to trade</p>
                    <a href="profile.php" style="text-align:center">visit page</a>
                </div>
            </div>
        </div>
